                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-end">
                                <h4 class="mb-0">Transaksi Bulanan</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th>
                                                            <?php if (empty($tr['driver_name']) || $tr['driver_name'] == 'D0') { ?>
                                                                <p class="text-info">Cari driver</p>
                                                            <?php } else { ?>
                                                                <?= $tr['driver_name'] ?>
                                                            <?php } ?></th>
                                                        <th><?= $tr['service'] ?></th>
                                                        ...
                                                        <th><?= $currency ?>
                                                            <?= number_format($tr['final_cost'] / 1,0) ?></th>
                                                        <th>
                                                        ...
                                                        <th>
                                                            <?php if ($tr['status'] == '0') { ?>
                                                                <label class="badge badge-danger">Tidak ada driver</label>
