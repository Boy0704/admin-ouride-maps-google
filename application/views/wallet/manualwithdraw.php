                                            ...
                                            <div class="row">
                                                        ...
                                                        <select class="select2 form-group" name="customer_id">
                                                            <?php foreach ($balance as $sl) {
                                                                if (substr($sl['id_user'], 0, 1) == 'P') { ?>
                                                                    <option value="<?= $sl['id_user'] ?>"><?= $sl['customer_fullname'] ?> (<?= $currency['duit'] ?><?= number_format($sl['balance'] / 1,0) ?>)</option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                    </div>
                                                        ...
                                                        <select class="select2 form-group" name="driver_id">
                                                            <?php foreach ($balance as $sl) {
                                                                if (substr($sl['id_user'], 0, 1) == 'D') { ?>
                                                                    <option value="<?= $sl['id_user'] ?>"><?= $sl['driver_name'] ?> (<?= $currency['duit'] ?><?= number_format($sl['balance'] / 1,0) ?>)
                                                                    </option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                        ...
                                                        <select class="select2 form-group" name="partner_id">
                                                            <?php foreach ($balance as $sl) {
                                                                if (substr($sl['id_user'], 0, 1) == 'M') { ?>
                                                                    <option value="<?= $sl['id_user'] ?>"><?= $sl['partner_name'] ?> (<?= $currency['duit'] ?><?= number_format($sl['balance'] / 1,0) ?>)
                                                                    </option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="0" class="form-control" id="balance" name="balance" placeholder="enter Amount" value="">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
