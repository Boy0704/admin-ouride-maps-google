                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-start pb-0">
                                <div>
                                    <h2 class="text-bold-700 mb-0">
                                        <?= $currency ?>
                                        <?= number_format($balance['total'] / 1,0) ?>
                                    </h2>
                            ...
                            <div class="card-header d-flex align-items-start pb-0">
                                <div>
                                    <h2 class="text-bold-700 mb-0">
                                        ...
                                        ?>
                                        <?= $currency ?>
                                        <?= number_format($totaldiscount['discount'] / 1,0) ?>
                                    </h2>
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-start pb-0">
                                <div>
                                    <h2 class="text-bold-700 mb-0">
                                        <?= $currency ?>
                                        <?= number_format($totaltopup['total'] / 1,0) ?>
                                    </h2>
                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-start pb-0">
                                <div>
                                    <h2 class="text-bold-700 mb-0">
                                        <?= $currency ?>
                                        <?= number_format($totalwithdraw['total'] / 1,0) ?>
                                    </h2>
                            ...
                            <div class="card-header d-flex align-items-start pb-0">
                                <div>
                                    <h2 class="text-bold-700 mb-0" style="font-size: 18px;">
                                        ...
                                        <?= $currency ?>
                                        <?= number_format($totalorderplus['total'] / 1,0) ?>
                                    </h2>
                                ...
                                <div>
                                    <h2 class="text-bold-700 mb-0" style="font-size: 18px;">
                                        ...
                                        <?= $currency ?>
                                        <?= number_format($totalordermin['total'] / 1,0) ?>
                                    </h2>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <h2 class="text-bold-700"><?= $currency ?>
                                    <?= number_format($totaltopupadmin['totaltopupbyadmin'] / 1,0) ?></h2>
                ...
                <div class="col-xl-3 col-md-4 col-sm-6">
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                <h2 class="text-bold-700"><?= $currency ?>
                                    <?= number_format($totaltopupstripe['totaltopupbystripe'] / 1,0) ?></h2>
                ...
                <div class="col-xl-3 col-md-4 col-sm-6">
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                <h2 class="text-bold-700"><?= $currency ?>
                                    <?= number_format($totaltopuppaypal['totaltopupbypaypal'] / 1,0) ?></h2>
                ...
                <div class="col-xl-3 col-md-4 col-sm-6">
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                <h2 class="text-bold-700"><?= $currency ?>
                                    <?= number_format($totaltopuptransfer->row('totaltopupbytransfer') / 1,0) ?></h2>
