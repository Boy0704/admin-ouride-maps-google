                            ...
                            <div class="card-body text-center mx-auto">
                                ...
                                <div class="d-flex justify-content-between mt-2">
                                    ...
                                    <div class="following">
                                        <p class="font-weight-bold font-medium-2 mb-0"><?= $currency ?>
                                            <?= number_format($partner['balance'] / 1,0) ?></p>
                                ...
                                <?php if ($partner['partner_status'] == 0) { ?>
                                    <a href="<?= base_url(); ?>detailuser/confirmmerchant/<?= $partner['partner_id'] ?>">
                                        <h3 class="btn btn-success col-12 mt-2">Confirm Mitra</h3>
                                    </a>
                                <?php } ?>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                foreach ($transaction as $tr) { ?>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <?= $currency ?>
                                                                                            <?= number_format($tr['total_price'] / 1,0) ?>
                                                                                        </td>
                                                                                        <td>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <?php if ($wl['type'] == 'topup' or $wl['type'] == 'Order+') { ?>
                                                                                            <td class="text-success">
                                                                                                <?= $currency ?>
                                                                                                <?= number_format($wl['wallet_amount'] / 1,0) ?>
                                                                                            </td>
                                                                                ...
                                                                                foreach ($item as $it) { ?>
                                                                                    <tr>
                                                                                        ...
                                                                                        <?php if ($it['promo_status'] == 0) { ?>
                                                                                            <td><?= $currency ?><?= number_format($it['item_price'] / 1,0) ?></td>
                                                                                        <?php } else { ?>
                                                                                            <td style="text-decoration: line-through;"><?= $currency ?><?= number_format($it['item_price'] / 1,0) ?></td>
                                                                                        <?php } ?>
                                                                                        <?php if ($it['promo_status'] == 1) { ?>
                                                                                            <td class="text-success"><?= $currency ?><?= number_format($it['promo_price'] / 1,0) ?></td>
                                                                                        <?php } else { ?>
