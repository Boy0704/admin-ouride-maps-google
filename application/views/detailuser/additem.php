                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" id="item_price" class="form-control" name="item_price" placeholder="enter item price <?= $currency ?>" value="" data-type="0" pattern="^\d+(\.|\,)\d{2}$" required="required"></div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-8">
                                                            <div id="yescheck" style="display:block;" class="form-group">
                                                                ...
                                                                <input type="text" id="yes" class="form-control" name="promo_price" pattern="^\d+(\.|\,)\d{2}$" data-type="0" placeholder="enter promo price(<?= $currency ?>)"></div>
                                                        </div>
                                                    </div>
                                                </div>
