                                ...
                                <div class="card-body">
                                    <ul class="activity-timeline timeline-left list-unstyled">
                                        <li>
                                            ...
                                            <div class="timeline-info">
                                                <p class="font-weight-bold">Lokasi Mitra</p>
                                                <span><?= $transaction['pickup_address'] ?></span>
                                            </div>
                                                            ...
                                                            <?php foreach ($itemtransaction as $item) { ?>
                                                                <ul class="list-group list-group-flush">
                                                                    <li class="list-group-item">
                                                                        <?= $currency ?>
                                                                        <?= number_format($item['total_cost'] / 1,0) ?>
                                                                    </li>
                                                                </ul>
                                                            <?php } ?>
                                                        </td>
                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?= $currency ?>
                                                            <?= number_format($transaction['cost'] / 1,0) ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?= $currency ?>
                                                            <?= number_format($transaction['price'] / 1,0) ?>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        <tr>
                                                            <th>ITEM PRICE</th>
                                                            <td><?= $currency ?>
                                                                <?= number_format($transaction['total_belanja'] / 1,0) ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th>DELIVERY</th>
                                                            <td><?= $currency ?>
                                                                <?= number_format($transaction['price'] / 1,0) ?></td>
                                                        </tr>
                                                        <tr>
                                                            <th>DISCOUNT
                                                            ...
                                                            <td class="text-danger">
                                                                <?= $currency ?>
                                                                <?= number_format($transaction['promo_discount'] / 1,0) ?>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>PAYMENT</th>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="card-title"><?= $currency ?>
                                                                <?= number_format($transaction['final_cost'] / 1,0) ?></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
                                                ...
                                                <table class="table table-borderless">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="card-title">
                                                                <?= $currency ?>
                                                                <?= number_format($transaction['final_cost'] / 1,0) ?>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
