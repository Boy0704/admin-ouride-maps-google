                                            ...
                                            <input type="hidden" name="promo_id" value="<?= $promo['promo_id'] ?>">
                                                ...
                                                <?php if ($promo['promo_type']  == 'persen') { ?>
                                                    ...
                                                    <div id="fixcheck" class="col-12 form-group" style="display:none;">
                                                        ...
                                                        <input id="fixcheckrequired" type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="0" class="form-control" id="promo_amount" name="promo_amount" value="<?= number_format($promo['promo_amount'] / 1,0); ?>" placeholder="enter promo amount">
                                                    </div>
                                                <?php } else { ?>
