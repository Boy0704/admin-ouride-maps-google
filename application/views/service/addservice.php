                                        ...
                                        <div class="form-body">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="col-12 form-group">
                                                    ...
                                                    <input type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="0" class="form-control" id="newstitle" name="cost" required>
                                                </div>
                                                <div class="col-12 form-group">
                                                ...
                                                <div class="col-12 form-group">
                                                    ...
                                                    <input type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="0" class="form-control" id="newstitle" name="minimum_cost" required>
                                                </div>
                                                <div class="col-12 form-group">
                                                ...
                                                <div class="col-12 form-group">
                                                    ...
                                                    <input type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="0" class="form-control" id="newstitle" name="minimum_wallet" required>
                                                </div>
                                                <div class="col-12 form-group">
