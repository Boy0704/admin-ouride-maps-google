                                        ...
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12 form-group">
                                                    ...
                                                    <input type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="0" class="form-control" id="newstitle" name="cost" value="<?= number_format($cost / 1,0) ?>" required>
                                                </div>
                                                <div class="col-12 form-group">
                                                ...
                                                <div class="col-12 form-group">
                                                    ...
                                                    <input type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="0" class="form-control" id="newstitle" name="minimum_cost" value="<?= number_format($minimum_cost / 1,0) ?>" required>
                                                </div>
                                                <div class="col-12 form-group">
                                                ...
                                                <div class="col-12 form-group">
                                                    ...
                                                    <input type="text" pattern="^\d+(\.|\,)\d{2}$" data-type="0" class="form-control" id="newstitle" name="minimum_wallet" value="<?= number_format($minimum_wallet / 1,0) ?>" required>
                                                </div>
                                                <div class="col-12 form-group">
