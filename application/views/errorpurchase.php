          ...
          <div class="col-lg-7 mx-auto text-white">
            <div class="row align-items-center d-flex flex-row">
              <div class="col-lg-6 text-lg-right pr-lg-4">
                <h1 class="display-1 mb-0"><i class="mdi mdi-emoticon-sad"></i></h1>
              </div>
              <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                <h2>SORRY!</h2>
                <h3 class="font-weight-light">Haven't purchased this app yet <br><a class="badge badge-light text-primary"href="https://jek.my.id">Purchase Now Here</a></h3>
              </div>
            </div>
            <div class="row mt-5">
              <div class="col-12 mt-xl-2">
                <p class="text-white font-weight-medium text-center">Copyright &copy; Om Daeng Team 2020 All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
